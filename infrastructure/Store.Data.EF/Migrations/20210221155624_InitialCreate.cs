    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "D. Knuth", "This volume begins with...", "ISBN01235437898", 7.19m, "Art Of Programming" });

            migrationBuilder.InsertData(
                table: "Books",
                columns: new[] { "Id", "Author", "Description", "Isbn", "Price", "Title" },
                values: new object[] { 2, "M. Fowler", "As the application of object...", "ISBN01235437854", 12.45m, "Refactoring" });

            migrationBuilder.InsertData(
                table: "Books",
                columns: new[] { "Id", "Author", "Description", "Isbn", "Price", "Title" },
                values: new object[] { 3, "B. W. Kernighan, D. M. Ritchie", "Known as the bible of C...", "ISBN01235439863", 14.98m, "C Programming Language" });
