...
namespace Store.Web.App
{
    public class OrderService
    {
        ...
        public async Task<OrderModel> SendConfirmationAsync(string cellPhone)
        {
            ...
            {
                var confirmationCode = 1111; // TO DO: random.Next(1000, 10000) = 1000, 1001, ... ,9998, 9999
                ...
                model.Errors["cellPhone"] = "Номер телефона не соответствует формату +380*********";
        ...
        public async Task<OrderModel> ConfirmCellPhoneAsync(string cellPhone, int confirmationCode)
        {
            ...
            if (storedCode == null)
            {
                model.Errors["cellPhone"] = "Что-то пошло не так. Попробуйте получить код еще раз.";
                return model;
            }
